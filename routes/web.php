...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth:admin', 'check_expired_subs')->group(function () {
        ...
        Route::post('/about_last_section_post', [
            DashboardController::class,
            'about_last_section_post'
        ])->name('about_last_section_post');
        ...
        Route::get('/contact_delete/{id}', [
            DashboardController::class,
            'contact_delete'
        ])->name('contact_delete');

        Route::get('/admin/legal_documentation', [
            DashboardController::class,
            'admin_legal_documentation'
        ...
        Route::put('/admin/legal/title/update', [
            DashboardController::class,
            'legal_update'
        ])->name('legal.title.update');
        Route::get('/resources', [
            DashboardController::class,
            'resources'
        ])->name('resources');
        ...
        Route::post('modules/posts/store/{id}', [
            DashboardController::class,
            'modules_posts_store'
        ])->name('modules.posts.store');
        ...
        Route::post(
            '/subscriptions/{subscription}/upload-file',
            [App\Http\Controllers\Admin\DashboardController::class, 'uploadFile']
        )->name('subscription.upload_file');
