        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.about_second_section_post') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        class="form-control @error('second_subtitle') is-invalid @enderror"
                        name="second_subtitle"
                        id="second_subtitle"
                        cols="10"
                        rows="5">{{ old('second_subtitle', $About_second_section->second_subtitle ?? '') }}</textarea>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.about_second_section_card_post') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        class="form-control @error('card_description') is-invalid @enderror"
                        name="card_description"
                        id="card_description"
                        cols="10"
                        rows="5">{{ old('card_description') }}</textarea>
