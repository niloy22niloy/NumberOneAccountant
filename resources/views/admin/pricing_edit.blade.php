        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" name="plan_type" value="{{ $plan->plan_type }}" class="form-control" required>
                </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" step="0.01" name="price" value="{{ $plan->price }}" class="form-control" required>
                </div>
            </div>
            ...
            <!-- 👇 New checkbox field for homepage display -->
            <div class="form-check mt-4">
                <input class="form-check-input" type="checkbox" name="homepage_show" id="homepage_show" value="1"
                    {{ $plan->homepage_show ? 'checked' : '' }}>
